...
@Component({
  selector: "ui-autocomplete-cdk",
  templateUrl: "./autocomplete-cdk.component.html",
  styleUrls: ["./autocomplete.component.scss"],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => AutocompleteCdkComponent),
      multi: true,
    },
  ],
  imports: [
...
export class AutocompleteCdkComponent
  implements ControlValueAccessor, AfterViewInit
{
  ...
  filteredListElement = viewChild<ElementRef<HTMLUListElement>>(
    "filteredListElement"
  );
  ...
  searchInputWidth = computed(
    () => this.searchInput()?.nativeElement?.offsetWidth ?? 400
  );
